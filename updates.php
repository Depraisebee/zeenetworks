...
<head>
    ...
    <title>Zeenetworks | Updates</title>
    ...
    position: relative;
        ...
        .updates{
            ...
            padding: 8px;
           /* background-image: url(img/bakgnd.png); */   
            background: linear-gradient(to right, #f3faf5, #628ecb);
           padding-bottom: 2%;
           background-position: center;
           background-size: cover;
           background-repeat: no-repeat;
...
<div id="menu">
    ...
    <ul>
        ...
        <li class="actives"><a href="updates.php"><i class="fas fa-newspaper"></i> Updates</a> </li>
