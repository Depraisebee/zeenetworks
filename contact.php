...
<head>
    ...
    <title>Zeenetworks | Contact us</title>
...
<div id="menu">
    ...
    <ul>
        ...
        <li class="actives"><a href="contact.php"><i class="fa fa-phone"></i> Contact Us</a></li>
...
<div id="interface" class=" sm-6">
    ...
    <div id="navigation">
          ...
          $sql = "SELECT * FROM students WHERE student_id = {$_SESSION['student_id']}";
            $query = mysqli_query($conn, $sql);
                 ...
                 <?php while($row = mysqli_fetch_assoc($query)) { ?>
                    <a class="text-dark" style="text-decoration: none;" href="profile.php?<?php  echo 'studentId='.$student_id.'%profile$'?>"> <img src="profiles/<?php echo $row['profile_image']; ?>" alt="profile">
                  <?php } ?>
                </a>  
               </div>
        <div class="icons">
        ...
        <div class="home mt-5 p-5">
            <h1>Are you having challenges</h1>
               <p>We are available Just reach us and get 24/7 customer support.</p>

        </div>
       <!-- this code is for contact us page-->
       <section class="contact">
            <h2>Get in touch</h2>
             <div class="card">
              <h4>24/7  Service</h4>   
             <p>We have our 24/7 customer care support. So we have got you covered.</p>
           </div>
            <div class="card bg-success">
                <h4 class="">Location and contact</h4>   
                <p class="text-dark">Visit our offices in Serenje town center. Along Nganswa Road.</p>   
            <p class="text-dark">You can Reach us: <a href="tel:+260976445026">Call us: 0976445026</a> or <a href="https://wa.me/+260976445026">Whatsapp us: 0976445026</a></p>            
                </div>
