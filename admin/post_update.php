...
<body id="body" class="bg-dark">
    ...
    <section id="menu">
        ...
        <div class="items ">
            <li ><i class=""></i><a href="home.php">Dashboard</a></li>
            <li><i></i><a href="View_registered_student.php">View Registered Students</a></li>
            <li class="actives"><i></i><a href="post_update.php">Post Update</a></li>
    ...
    <section id="interface">
        ...
        <h3 class="i-name ">Post an Update</h3>
        <div class="theme">
        ...
        <div class="post">
            ...
            <div class="post-area">
                <form action="post_update.php" method="POST" accept-charset="utf-8">
                    <textarea name="update" rows="16" cols="27"></textarea>
